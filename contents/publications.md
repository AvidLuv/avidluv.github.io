- <strong>Line-Following Buggy</strong>: 
    <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div style="flex: 1; text-align: right; padding-left: 20px;">
            <img src="static/assets/line_following_buggy.gif" alt="Line-Following Buggy GIF" style="max-width: 300px; border-radius: 5px;"/>
        </div>
    </div>
...
- <strong>Dynamic Gesture Recognition</strong>: 
    <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div style="flex: 1; text-align: right; padding-left: 20px;">
            <img src="static/assets/dynamic_gesture_recognition.gif" alt="Dynamic Gesture Recognition GIF" style="max-width: 300px; border-radius: 5px;"/>
        </div>
    </div>
